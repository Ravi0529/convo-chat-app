          ...
          {isLogin ? ( // sign in form
            <div className="space-y-6">
              ...
              <form className="space-y-4" onSubmit={handleLogin}>
                ...
                <button
                  type="submit"
                  className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium ${isLoginPending ? 'bg-gray-400' : 'bg-indigo-600'} hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 text-white transition-colors duration-200`}
            ...
            <div className="space-y-6">
              ...
              <form className="space-y-4" onSubmit={handleSignUp}>
                ...
                <button
                  type="submit"
                  className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium ${isRegisterPending ? 'bg-gray-400' : 'bg-green-600'} hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200 text-white`}
